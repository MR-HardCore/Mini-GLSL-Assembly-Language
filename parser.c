...
{
       0,   132,   132,   138,   144,   148,   153,   157,   162,   165,
     168,   174,   177,   180,   183,   186,   192,   195,   198,   201,
...
#line 184 "parser.y" /* yacc.c:1646  */
    ...
    (yyval.as_ast) = ast_allocate(STATEMENT_SCOPE_NODE, (yyvsp[0].as_ast)); }
...
#line 287 "parser.y" /* yacc.c:1646  */
    { yTRACE("expression -> ( expression ) \n");
    (yyval.as_ast) = ast_allocate(EXPR_EXPR_NODE, (yyvsp[-1].as_ast)); }
...
#line 290 "parser.y" /* yacc.c:1646  */
    ...
    (yyval.as_ast) = ast_allocate(EXPR_VAR_NODE, (yyvsp[0].as_ast)); }
